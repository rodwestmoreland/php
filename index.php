<!DOCTYPE html>
<html lang="en"><head><title>RODW</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="slider-wrapper">
        <div class="slider-container">
            <div class="slide active" data-order="2">
                <div class="slide-content txt">
                    <div class="txt-wrapper">
                        <span class="copy">hi.</span>
                        <h2 class="copy2">I’m rod.</h2>
                    </div>
                </div>  
                <div class="slide-content img">
                    <img src="img/horse.jpg" alt="personal portfolio" />
                </div>  
            </div>
        </div>
            ...
            <div class="col-12 col-sm-4 offset-sm-1">
                ...
                <div class="row">
                    <ul>
                        ...
                        <li><a href="/phprps/index.php">      Rock Paper Scissors </a></li>
        ...
        <div class="row row-content bottom-border">
           <div class="col-12">
